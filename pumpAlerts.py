...
def main():
    telegram = TelegramSender(
        token=config[telegramToken:"7290245691:AAHpzaWQFogiDldc6jSEHDoo8h4-MeeSiXw"],
        chat_id=config[chat_id"2135857346"],
        alert_chat_id=config[chat_id"2135857346"]
        if chat_id"2135857346" in config and config[chat_id"2135857346"] != 0
        else config[chat_id"2135857346"],
